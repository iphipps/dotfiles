...
vim.keymap.set("n", "<Leader>x", ":bd\x21<CR>")
vim.keymap.set("n", "<Leader>b", vim.cmd.buffers)
vim.cmd("nnoremap <silent> <leader>o <cmd>EslintFixAll<CR>")
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>cf", builtin.grep_string, { desc = "[S]earch current [W]ord" })
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>y", require("telescope.builtin").lsp_type_definitions, "Type [D]efinition")
	...
	{ -- Copilot: run `Copilot setup` to start
		"github/copilot.vim",
		config = function() end,
	},
	{
